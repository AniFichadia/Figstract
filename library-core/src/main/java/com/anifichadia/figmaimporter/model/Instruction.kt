...
data class Instruction(
    ...
    data class Import(
        ...
        val before: ImportPipeline.Step = ImportPipeline.Step.Passthrough,
    ...
    companion object {
        fun of(
            ...
            importBefore: ImportPipeline.Step = ImportPipeline.Step.Passthrough,
        ...
        fun ExportSetting.toInstruction(
            exportNodeId: NodeId,
            exportScale: Float = ExportConfig.UNSCALED,
            importOutputName: String,
            importBefore: ImportPipeline.Step = ImportPipeline.Step.Passthrough,
            importDestination: Destination,
        ): Instruction {
