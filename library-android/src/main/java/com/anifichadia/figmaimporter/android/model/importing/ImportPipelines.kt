 ...
 */
fun androidImageDownscaleToBuckets(
    imageDirectory: File,
    ...
    return densityBuckets
        .map { targetDensity -> androidImageDownscaleAndBucket(imageDirectory, sourceDensity, targetDensity) }
        .and()
}

fun androidImageDownscaleAndBucket(
    imageDirectory: File,
    sourceDensity: DensityBucket,
